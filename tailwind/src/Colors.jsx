    ...
    <>
      <section className="pb-5">
        <div className="grid grid-cols-10 gap-2 pb-2">
          {/* custom bg-color */}
          <div className="text-red-50 aspect-square">text 1</div>
          <div className="text-green-500 aspect-square">text 2</div>
          <div className="text-test-color aspect-square">custom text color</div>

        </div>
        <div className="grid grid-cols-10 gap-2 pb-2">
          {/* custom bg-color */}
          <div className="bg-test-color"></div>
